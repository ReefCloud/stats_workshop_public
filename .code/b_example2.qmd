---
title: "Bayesian modelling part2"
author: "Murray Logan"
date: today
...
```{r}
#| label: readData
dat <- read_csv("../data/HorseshoeReefSite1.csv", trim_ws = TRUE)
```
...
form <- bf(COUNT | trials(TOTAL) ~ fYear,
...
model2 |>
  ...
  scale_fill_manual(values = c("gray80", "skyblue"), limits = c(FALSE, TRUE))
```
...
cmat <- cbind(`2017 vs 2018-22` = c(1, -1/3, -1/3, -1/3))
